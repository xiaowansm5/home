...
<script setup>
    ...
    import { Bars, Blog, Book, Cloud, Code, Cog, CompactDisc, Fan, Link, Music, PencilAlt, Search, SlidersH, Train, ShoppingCart, AlignJustify, Images, NewspaperRegular } from "@vicons/fa";
    ...
    const icons = {
        ...
        "Images": Images,
        "NewspaperRegular": NewspaperRegular
    };
